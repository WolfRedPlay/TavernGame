...
namespace Gameplay.Tables
{
    public class TableStateManager : StateManager<TableState>
    {
        ...
        private List<Core.Shared.ClientsData.Client> _clients = new List<Core.Shared.ClientsData.Client>();
        ...
        public void Initialize(TableInteractable interactable, List<Core.Shared.ClientsData.Client> clientsList, Table table)
        {
